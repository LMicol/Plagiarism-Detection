...
if __name__ == '__main__':
    ...
    ## Done: Define a model 
    # I tested with some algorithms to see how they performed
    
    # model = AdaBoostClassifier() ## final acc = 0.92
    # model = DecisionTreeClassifier() ## final acc = 0.92
    model = LinearSVC() ## final acc = 1.0
